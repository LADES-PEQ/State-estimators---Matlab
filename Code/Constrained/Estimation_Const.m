function [X_est, Y_est, Pxx_est, X_vector, Pxx_vector, Esf_vector] =...
    Estimation_Const(F, H, X0, U_vector, Z_vector, Q, R, Jacob_x, Jacob_y,...
    Constraints, N_smo, flag_est, N_points, X_comp, P0, varargin)
% Recursive estimation of a constrained system for a predefined analysis
...
for k = 1:N_k-1
    ...
    switch flag_est
        case 0 % Constrained steady extended Kalman filter and smoother (CSEKFS)
            [Pxx_vector(1:nx,1:nx,k-N_smo:k+1), X_vector(1:nx,k-N_smo:k+1),...
                Xpri_vector(1:nx,k-N_smo:k+1), phi_vector(1:nx,1:nx,k-N_smo:k+1)] =...
                CEKFS(F, H, X_vector(1:nx,k-N_smo:k), U_vector(1:nu,k-N_smo:k),...
                Pxx_vector(1:nx,1:nx,k-N_smo:k), Z_vector(1:ny,k-N_smo:k+1),...
                Q_vector(1:nx,1:nx,k-N_smo:k), R_vector(1:ny,1:ny,k-N_smo:k+1),...
                Constraints, Jacob_x, Jacob_y, Xpri_vector(1:nx,k-N_smo:k),...
                phi_vector(1:nx,1:nx,k-N_smo:k),1);
        case 1 % Constrained extended Kalman filter and smoother (CEKFS)
            [Pxx_vector(1:nx,1:nx,k-N_smo:k+1), X_vector(1:nx,k-N_smo:k+1),...
                Xpri_vector(1:nx,k-N_smo:k+1), phi_vector(1:nx,1:nx,k-N_smo:k+1)] =...
                CEKFS(F, H, X_vector(1:nx,k-N_smo:k), U_vector(1:nu,k-N_smo:k),...
                Pxx_vector(1:nx,1:nx,k-N_smo:k), Z_vector(1:ny,k-N_smo:k+1),...
                Q_vector(1:nx,1:nx,k-N_smo:k), R_vector(1:ny,1:ny,k-N_smo:k+1),...
                Constraints, Jacob_x, Jacob_y, Xpri_vector(1:nx,k-N_smo:k),...
                phi_vector(1:nx,1:nx,k-N_smo:k),0);
        case 2 % Constrained unscented Kalman filter and smoother (UKFS)
            [Pxx_vector(1:nx,1:nx,k-N_smo:k+1), X_vector(1:nx,k-N_smo:k+1),...
                Points_vector(1:nx,1:N_points,k-N_smo:k+1),...
                Points_priori(1:nx,1:N_points,k-N_smo:k+1)] = CUKFS(F, H,...
                X_vector(1:nx,k-N_smo:k), U_vector(1:nu,k-N_smo:k),...
                Pxx_vector(1:nx,1:nx,k-N_smo:k), Z_vector(1:ny,k-N_smo:k+1),...
                Q_vector(1:nx,1:nx,k-N_smo:k), R_vector(1:ny,1:ny,k-N_smo:k+1),...
                Constraints, Points_vector(1:nx,1:N_points,k-N_smo:k),...
                Points_priori(1:nx,1:N_points,k-N_smo:k));
        case 3 % Constrained cubature Kalman filter and smoother (CKFS)
            [Pxx_vector(1:nx,1:nx,k-N_smo:k+1), X_vector(1:nx,k-N_smo:k+1),...
                Points_vector(1:nx,1:N_points,k-N_smo:k+1),...
                Points_priori(1:nx,1:N_points,k-N_smo:k+1)] = CCKFS(F, H,...
                X_vector(1:nx,k-N_smo:k), U_vector(1:nu,k-N_smo:k),...
                Pxx_vector(1:nx,1:nx,k-N_smo:k), Z_vector(1:ny,k-N_smo:k+1),...
                Q_vector(1:nx,1:nx,k-N_smo:k), R_vector(1:ny,1:ny,k-N_smo:k+1),...
                Constraints, Points_vector(1:nx,1:2*nx,k-N_smo:k),...
                Points_priori(1:nx,1:N_points,k-N_smo:k));
        case 4 % Constrained particle filter and smoother (CPFS)
            [Pxx_vector(1:nx,1:nx,k-N_smo:k+1), X_vector(1:nx,k-N_smo:k+1),...
                Points_vector(1:nx,1:N_points,k-N_smo:k+1),...
                Particle_W(1:N_points,k-N_smo:k+1), Points_priori(1:nx,1:N_points,k-N_smo:k+1)] =...
                CPFS(F, H, Points_vector(1:nx,1:N_points,k-N_smo:k), X_vector(1:nx,k-N_smo:k), U_vector(1:nu,k-N_smo:k),...
                Pxx_vector(1:nx,1:nx,k-N_smo:k), Z_vector(1:ny,k-N_smo:k+1), Q_vector(1:nx,1:nx,k-N_smo:k),...
                R_vector(1:ny,1:ny,k-N_smo:k+1),...
                Particle_W(1:N_points,k-N_smo:k), Points_priori(1:nx,1:N_points,k-N_smo:k), Constraints, Jacob_y);
        case 5 % Constrained ensemble Kalman filter and smoother (CEnKFS)
            [Pxx_vector(1:nx,1:nx,k-N_smo:k+1), X_vector(1:nx,k-N_smo:k+1),...
                Points_vector(1:nx,1:N_points,k-N_smo:k+1),...
                Points_priori(1:nx,1:N_points,k-N_smo:k+1)] = CEnKFS(F, H,...
                Points_vector(1:nx,1:N_points,k-N_smo:k), U_vector(1:nu,k-N_smo:k),...
                Pxx_vector(1:nx,1:nx,k-N_smo:k), Z_vector(1:ny,k-N_smo:k+1),...
                Q_vector(1:nx,1:nx,k-N_smo:k), R_vector(1:ny,1:ny,k-N_smo:k+1),...
                Constraints, Jacob_y, X_vector(1:nx,k-N_smo:k),...
                Points_priori(1:nx,1:N_points,k-N_smo:k));
    end
