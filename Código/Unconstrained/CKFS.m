...
for i = 1:N-1
    ...
    for j = 1:2*nx
        Pxx_priori = Pxx_priori+Wc*(Cubature_priori(1:nx,j)-x_priori)*...
            (Cubature_priori(1:nx,j)-x_priori)'; % Eq. 10.9 part 2
        Pxx_cross = Pxx_cross+Wc*(Cubature_points(1:nx,j)-X_vector(1:nx,N-i))*...
            (Cubature_priori(1:nx,j)-x_priori)'; % Eq. 10.9 part 3
    end
