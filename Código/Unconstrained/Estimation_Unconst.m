...
for k = 1:N_k-1
    ...
    switch flag_est
        case 1 % Extended Kalman filter and smoother (EKF&S)
            [Pxx_vector(1:nx,1:nx,k-N_smo:k+1), X_vector(1:nx,k-N_smo:k+1),...
                ...
                Jacob_x, Jacob_y, Xpri_vector(1:nx,k-N_smo:k), phi_vector(1:nx,1:nx,k-N_smo:k));
        case 2 % Unscented Kalman filter and smoother (UKF&S)
            [Pxx_vector(1:nx,1:nx,k-N_smo:k+1), X_vector(1:nx,k-N_smo:k+1),...
        ...
        case 3 % Cubature Kalman filter and smoother (CKF&S)
            [Pxx_vector(1:nx,1:nx,k-N_smo:k+1), X_vector(1:nx,k-N_smo:k+1),...
        ...
        case 4 % Particle filter and smoother (PF&S)
            [Pxx_vector(1:nx,1:nx,k-N_smo:k+1), X_vector(1:nx,k-N_smo:k+1),...
        ...
        case 5 % Ensemble Kalman filter and smoother (EnKF&S)
            [Pxx_vector(1:nx,1:nx,k-N_smo:k+1), X_vector(1:nx,k-N_smo:k+1),...
                Points_vector(1:nx,1:N_points,k-N_smo:k+1),...
